    ...
    <footer className="pb-3 text-white bg-black pt-14">
      <Wrapper className="flex justify-between flex-col md:flex-row gap-[50px] md:gap-0">
        ...
        <div className="flex justify-center gap-4 md:justify-start">
          ...
          <Link href='https://youtube.com' target="_blank" className="w-10 h-10 rounded-full bg-white/[0.25] flex items-center justify-center text-black hover:bg-white/[0.5] cursor-pointer">
            <FaYoutube size={20} />
          </Link>
          <Link href='https://instagram.com' target="_blank" className="w-10 h-10 rounded-full bg-white/[0.25] flex items-center justify-center text-black hover:bg-white/[0.5] cursor-pointer">
            <FaInstagram size={20} />
          </Link>
        </div>
        {/* RIGHT END */}
